        ...
        <div className="w-full mt-6 px-6 py-4 bg-white overflow-hidden rounded-lg shadow-md">
            ...
            <form >
                ...
                <div className="flex items-center justify-end mt-4">
                    <a href={`/admin/fiches/export/${delai}/${dayjs(new Date(mois)).format("YYYY-MM")}/${dayjs(new Date(annee)).format("YYYY-MM")}`} onClick={() => setTimeout(function () { setannee(''); setmois(''); setdelai('') }, 2000)}
